...
import com.kr.lg.model.web.net.response.user.FindIUResponse;
import com.kr.lg.model.web.net.response.user.FindIFUResponse;
import com.kr.lg.model.web.net.response.user.FindUAResponse;
import com.kr.lg.model.web.net.response.user.FindUBResponse;
