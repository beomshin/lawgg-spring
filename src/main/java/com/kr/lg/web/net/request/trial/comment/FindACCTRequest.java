package com.kr.lg.web.net.request.trial.comment;
...
@AllArgsConstructor
@NoArgsConstructor
@ApiModel(value = "트라이얼 게시판 익명 자식 댓글 조회 요청 바디")
public class FindACCTRequest implements RootRequest { // FindAnonymousChildrenCommentTrialRequest
